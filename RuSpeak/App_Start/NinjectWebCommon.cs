...
using RuSpeak.DAL.Concrete;
using RuSpeak.Global.Auth;
using RuSpeak.Infrastructure.Mappers;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(RuSpeak.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(RuSpeak.App_Start.NinjectWebCommon), "Stop")]
